 ...
 <script src="js/jquery-ui-1.10.3.custom.min.js"></script>
    ...
    <script type="text/javascript">
        ...
        if(success != null && success == "success"){
            ...
            $('#dialog').html('Audio message as been uploaded !! ');
             $('#dialog').dialog('open');
        }
    ...
    <div id="wrapper">
      ...
      <div id="page-content-wrapper">
        ...
        <div id="content">
          ...
          <form action="controls/Uploadaudio.php" method="post" enctype="multipart/form-data" >
            <table width="669" border="0">
              ...
              <tr>
                <td>&nbsp;</td>
                <td><input type="submit" name="uploadaudio" id="submit" value="Upload" class="button"> 
